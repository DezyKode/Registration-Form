...
const StudentForm = () => {
    ...
    const validateForm = useCallback(() => {
        ...
        const isValid = student.firstName && student.lastName && student.dateOfBirth &&
            student.age && student.gender && student.address && student.state &&
            student.city && student.pincode && student.educationQualification &&
            isQualificationValid && student.yearOfPassing &&
            (student.yearOfPassing !== 'Complete' || student.yearOfCompletion) &&
            student.interestedCourse && student.referredBy && isReferredByValid;
    ...
    useEffect(() => {
        const fetchStates = async() => {
            try {
                ...
                const india = response.data.data.find((country) => country.name === "India");
        ...
        style = {
            { width: '500px' }
                ...
                serviceType === '' ? (
                    ...
                    <h5> Select Service Type </h5> <div className = "d-md-flex d-block justify-content-center align-items-center mt-3 " > <div className = { `card mb-3 mx-auto me-md-3 ${selectedCard === 'Training' ? 'selected-card' : ''}` }
                    style = {
                        { width: '18rem', cursor: 'pointer' }
                    }
                    onClick = {
                        () => handleCardClick('Training')
                    }>
                    <h5 className = "card-title text-center mt-5 mb-5" > Training </h5> <img src = { require("./accets/training.png") }
                    ...
                    <img src = { require("./accets/Development.png") }
                    className = "card-img-bottom"
                    alt = "Development"
                    style = {
                        { height: '150px', objectFit: 'cover' }
                    ...
                    <h5 className = "text-center" > Enter Contact Details </h5> <form onSubmit = { handleContactSubmit } >
                    <div className = "mb-3" >

                    <label className = "form-label" >
                    <FontAwesomeIcon icon = { faUser }/> Name  </label> <input type = "text"
                    ...
                    <h4 className = "text-center" > Student Form </h4>  <div className = "row mb-3" >
                    <div className = "col" >
                    ...
                    <label className = "form-label" >
                    <FontAwesomeIcon icon = { faUser }/> Last Name </label > <input type = "text"
                    className = "form-control"
                    name = "lastName"
 ...
 <div className = "col" >
                        ...
                        <label className = "form-label mb-0 me-3" > Gender </label>  <div className = "d-flex align-items-center" >
...
label >
                        ...
                        style = {
                            { marginRight: '5px' }
                        } // Adjust spacing between input and icon
                        /> 
                        <i
                        ...
                        <FontAwesomeIcon icon = { faHome }/> Address </label > 
                        <input
                        type = "text"
                        className = "form-control"
                        name = "address"
                    ...
                    <label className ="form-label">
                    <FontAwesomeIcon icon = { faMapMarkerAlt }/> City </label> 
                    <select className ="form-control"
                    name = "city"
                    value = { student.city }
                    onChange = { handleChange }
                ...
                </div> <div className ="col"> <label className ="form-label">
            <FontAwesomeIcon icon = { faMapMarkerAlt }/> Pincode </label > <input
            type = "text"
            className = "form-control"
            name = "pincode"
            ...
            style = {
                { borderRadius: '35px' }
            } > Select </option>  <option value = "10th" > 10 th </option>  <option value = "12th" > 12 th </option>  <option value = "Graduate" > Graduate </option>  
            <option value = "Diploma" > Diploma </option>  
            <option value = "Degree" > Degree </option>
            <option value = "Post Graduate" > Post Graduate </option> <option value = "Other" > Other </option > </select>  </
            div> {
                student.educationQualification === 'Other' && ( <div className = "mb-3" >
...
/>  
            ...
            style = {
                { borderRadius: '35px' }
            } > Select </option>  <option value = "Complete" > Complete </option> 
            ...
            <FontAwesomeIcon icon = { faClipboardCheck }
            /> Interested Course  </label > <select style = {
                { borderRadius: '35px' }
            }
            ...
            style = {
                { borderRadius: '35px' }
            } > Select </option>  <option value = "Frontend Developer"> Frontend Developer </option>  
            ...
            style = {
                { borderRadius: '35px' }
            } > Select </option>  <option value = "Walk-in"> Walk - in </option>  
            ...
            {
                student.referredBy === 'Friend' && ( <div className = "mb-3" >
            ...
            onClick = { resetForm } > Reset </button>  <button type = "submit"
            className = "btn btn-warning"
    ...
    showModal && ( <div className = "modal show"
            ...
            <h5 className = "modal-title" > Enter OTP </h5>  <button type = "button"
            className = "btn-close"
            onClick = {
                () => setShowModal(false)
            } > </button>  
